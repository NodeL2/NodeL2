...
class Attack {
    ...
    meleeHit(session, npc) {
        ...
        session.dataSend(ServerResponse.attack(actor, npc.fetchId(), hitLanded ? 0x00 : 0x80), true);
    ...
    remoteHit(session, npc, skill) {
        ...
        session.dataSend(ServerResponse.skillStarted(actor, npc.fetchId(), skill), true);
