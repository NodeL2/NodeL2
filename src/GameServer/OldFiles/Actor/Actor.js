...
const Creature       = invoke('GameServer/Creature/Creature');
const Automation     = invoke('GameServer/Creature/Actor/Automation');
const Backpack       = invoke('GameServer/Creature/Actor/Backpack');
const Paperdoll      = invoke('GameServer/Creature/Actor/Paperdoll');
